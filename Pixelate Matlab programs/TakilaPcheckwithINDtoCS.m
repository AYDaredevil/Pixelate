function [CofCS,A,ColorOfIndicator,CofBot,CofRB,CofGB,EndFlag] = TakilaPcheckwithINDtoCS(r,resizedArrena,A,vid)
...
Path2D
EndFlag='P';
%[EndFlag,vid] = botMovement1checkwithIND(CofBot,CofGrid,Path2D,count,resizedArrena,A,r,resizedArrenaO,vid,EndFlag);
[EndFlag,vid] = botMovement1F(CofBot,CofGrid,Path2D,count,resizedArrena,A,r,resizedArrenaO,vid,EndFlag);
%[EndFlag,vid]=botMovement1(CofBot,CofGrid,Path2D,count,resizedArrena,A,r,resizedArrenaO,vid,EndFlag)
