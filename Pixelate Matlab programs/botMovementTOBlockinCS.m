function [EndFlag,vid,check] = botMovementTOBlockinCS(CofBot,CofGrid,Path2D,count,resizedArrena,A,r,resizedArrenaO,vid,EndFlag)
...
while count==(PathSize-1)
    ...
    [CofDestBlock] = ReachingBlock(PathSize,Path2D,r,ColorOfIndicator);                      %write in  cndtn such that iy operate once only??????????
